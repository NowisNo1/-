...
namespace Common
{
    public class PropertyHelper
    {
        ...
        /// <returns></returns>
        public static PropertyInfo[] GetProperties<T>(string cols, string real_cols="")
        {
            ...
            if (!string.IsNullOrEmpty(cols))
            {
                ...
                {
                    listCols = real_cols.GetStrList(',', true);//转换成List<string>，并转换成小写
                    
                }
                else
                {
                    listCols = cols.GetStrList(',', true);//转换成List<string>，并转换成小写
                }
